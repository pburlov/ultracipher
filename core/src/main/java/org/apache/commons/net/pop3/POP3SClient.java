...
public class POP3SClient extends POP3Client {
    ...
    /**
     * The FTPS {@link javax.net.ssl.TrustManager} implementation, default null.
     */
    private TrustManager trustManager = null;

    /**
     * The {@link javax.net.ssl.KeyManager}, default null.
     */
     ...
     * @see #POP3SClient(boolean, javax.net.ssl.SSLContext)
     */
     ...
     *
     * @throws java.io.IOException If it is thrown by _connectAction_().
     ...
     *
     * @throws java.io.IOException When could not initialize the SSL context.
     */
    ...
    /**
     * Get the {@link javax.net.ssl.KeyManager} instance.
     *
     * @return The current {@link javax.net.ssl.KeyManager} instance.
     */
    ...
    /**
     * Set a {@link javax.net.ssl.KeyManager} to use.
     *
     ...
     * When the underlying {@link java.net.Socket Socket} is not an {@link javax.net.ssl.SSLSocket} instance, returns null.
     *
     ...
     * @throws javax.net.ssl.SSLException If the server reply code is not positive.
    ...
    /**
     * Get the currently configured {@link javax.net.ssl.TrustManager}.
     *
    ...
    /**
     * Override the default {@link javax.net.ssl.TrustManager} to use.
     *
