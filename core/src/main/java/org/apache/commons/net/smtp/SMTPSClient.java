...
public class SMTPSClient extends SMTPClient {
    ...
    /**
     * The {@link javax.net.ssl.TrustManager} implementation, default null (i.e. use system managers).
     */
    private TrustManager trustManager = null;

    /**
     * The {@link javax.net.ssl.KeyManager}, default null (i.e. use system managers).
     */
     ...
     * @see #SMTPSClient(boolean, javax.net.ssl.SSLContext)
     */
