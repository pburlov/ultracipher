 ...
 *
 * @see org.apache.commons.net.smtp.SMTPClient
 * @since 3.0
 */
public class AuthenticatingSMTPClient extends SMTPSClient {
     ...
     * @throws SMTPConnectionClosedException If the SMTP server prematurely closes the connection as a result
     ...
     * @throws java.io.IOException                        If an I/O error occurs while either sending a
     *                                                    command to the server or receiving a reply from the server.
     * @throws java.security.NoSuchAlgorithmException     If the CRAM hash algorithm
     *                                                    cannot be instantiated by the Java runtime system.
     * @throws java.security.InvalidKeyException          If the CRAM hash algorithm
     *                                                    failed to use the given password.
     * @throws java.security.spec.InvalidKeySpecException If the CRAM hash algorithm
     *                                                    failed to use the given password.
     *                                                    *
     */
