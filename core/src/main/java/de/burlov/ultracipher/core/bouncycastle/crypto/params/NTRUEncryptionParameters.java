...
public class NTRUEncryptionParameters
     ...
     * @param c            a parameter for the Index Generation Function ({@link de.burlov.ultracipher.core.bouncycastle.crypto.engines.IndexGenerator})
     ...
     * @param sparse       whether to treat ternary polynomials as sparsely populated ({@link de.burlov.ultracipher.core.bouncycastle.math.ntru.polynomial.SparseTernaryPolynomial} vs {@link de.burlov.ultracipher.core.bouncycastle.math.ntru.polynomial.DenseTernaryPolynomial})
