package de.burlov.ultracipher.core.bouncycastle.crypto;
...
public interface AsymmetricBlockCipher {
     ...
     * @throws de.burlov.ultracipher.core.bouncycastle.crypto.DataLengthException the input data is too large for the cipher.
     */
