package de.burlov.ultracipher.core.bouncycastle.crypto.macs;
...
import de.burlov.ultracipher.core.bouncycastle.crypto.engines.DESEngine;
import de.burlov.ultracipher.core.bouncycastle.crypto.modes.CBCBlockCipher;
import de.burlov.ultracipher.core.bouncycastle.crypto.paddings.BlockCipherPadding;
...
public class ISO9797Alg3Mac
    ...
    public void init(CipherParameters params) {
        ...
        if (keyvalue.length == 16) { // Double length DES key
            key1 = new KeyParameter(keyvalue, 0, 8);
            this.lastKey2 = new KeyParameter(keyvalue, 8, 8);
            this.lastKey3 = key1;
        } else if (keyvalue.length == 24) { // Triple length DES key
            key1 = new KeyParameter(keyvalue, 0, 8);
            this.lastKey2 = new KeyParameter(keyvalue, 8, 8);
