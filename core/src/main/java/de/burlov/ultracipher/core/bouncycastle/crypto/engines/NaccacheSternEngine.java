package de.burlov.ultracipher.core.bouncycastle.crypto.engines;

import java.math.BigInteger;
import java.util.Vector;

import de.burlov.ultracipher.core.bouncycastle.crypto.AsymmetricBlockCipher;
...
import de.burlov.ultracipher.core.bouncycastle.crypto.InvalidCipherTextException;
import de.burlov.ultracipher.core.bouncycastle.crypto.params.NaccacheSternKeyParameters;
import de.burlov.ultracipher.core.bouncycastle.crypto.params.NaccacheSternPrivateKeyParameters;
import de.burlov.ultracipher.core.bouncycastle.crypto.params.ParametersWithRandom;
...
public class NaccacheSternEngine
     ...
     *
     * @param congruences the congruences c_i
     * @param primes      the primes p_i
     ...
     *
     * @see de.burlov.ultracipher.core.bouncycastle.crypto.AsymmetricBlockCipher#init(boolean,
     ...
     *
     * @see de.burlov.ultracipher.core.bouncycastle.crypto.AsymmetricBlockCipher#getInputBlockSize()
     */
     ...
     *
     * @see de.burlov.ultracipher.core.bouncycastle.crypto.AsymmetricBlockCipher#getOutputBlockSize()
     */
     ...
     *
     * @see de.burlov.ultracipher.core.bouncycastle.crypto.AsymmetricBlockCipher#processBlock(byte[],
     * int, int)
     */
     ...
     *
     * @param plain The BigInteger to encrypt
     ...
     *
     * @param block1 the first encrypted block
     * @param block2 the second encrypted block
