 ...
 *
 * @see de.burlov.ultracipher.core.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher {
     ...
     * @throws de.burlov.ultracipher.core.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
