...
public class AuthenticatingSMTPClient extends SMTPSClient {
     ...
     */
    public AuthenticatingSMTPClient(boolean implicit) throws NoSuchAlgorithmException {
        super(implicit);
    }
     ...
     *                                                    *
     */
    public boolean auth(AUTH_METHOD method, String username, String password) throws IOException, NoSuchAlgorithmException,
